...
<head>
    <meta charset="UTF-8">
    <title>Welcome to Result Analysis!</title>
...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to Result Analysis</h1>

        <h2>An online platform that allows
            users to find<span style="color: #419f89"> analised</span> result data! </h2>
